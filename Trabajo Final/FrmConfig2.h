...
namespace TrabajoFinal {
	...
	/// <summary>
	/// Resumen de FrmConfig2
	/// </summary>
	public ref class FrmConfig2 : public System::Windows::Forms::Form
	{
	public:
		FrmConfig2(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnIniciar->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->btnIniciar->Location = System::Drawing::Point(87, 141);
			this->btnIniciar->Name = L"btnIniciar";
			this->btnIniciar->Size = System::Drawing::Size(75, 37);
			this->btnIniciar->TabIndex = 5;
			this->btnIniciar->Text = L"Iniciar";
			this->btnIniciar->UseVisualStyleBackColor = true;
			this->btnIniciar->Click += gcnew System::EventHandler(this, &FrmConfig2::btnIniciar_Click);
			// 
			// txtnumEnemigos
			// 
			this->txtnumEnemigos->Location = System::Drawing::Point(121, 66);
			...
			// txtnumAliados
			// 
			this->txtnumAliados->Location = System::Drawing::Point(121, 102);
...
#pragma endregion
	private: System::Void btnIniciar_Click(System::Object^ sender, System::EventArgs^ e) {
		FrmSeguridad^ frm = gcnew FrmSeguridad(Convert::ToInt32(txtnumEnemigos->Value), Convert::ToInt32(txtnumAliados->Value));
		this->Hide();
		frm->ShowDialog();
		delete frm;
		this->Show();
