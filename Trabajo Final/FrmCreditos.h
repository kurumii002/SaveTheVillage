...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Location = System::Drawing::Point(119, 6);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(89, 94);
			...
			this->label2->Text = L"- Crisóstomo Napa Piero Israel (u202020287)";
			// 
			// label3
			// 
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(31, 211);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(264, 16);
			this->label3->TabIndex = 3;
			this->label3->Text = L"- Ortega Vélez Jamutaq Piero (u201911703)";
			// 
			// label4
			// 
			...
			this->label4->Text = L"- Puican Salas Kurt (u202016643)";
			// 
			// label5
			// 
			...
			this->label5->Size = System::Drawing::Size(301, 16);
			this->label5->TabIndex = 5;
			this->label5->Text = L"Trabajo Final del curso de Programación 2 - 2021";
			...
			this->label6->Text = L"Versión 4.0";
			// 
			// label7
			// 
			...
			this->label7->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label7->Location = System::Drawing::Point(12, 142);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(268, 16);
			this->label7->TabIndex = 7;
			this->label7->Text = L"© Grupo 7. Todos los derechos reservados.";
			// 
			// FrmCreditos
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(328, 278);
